...
(0, _domJs.select).addEventListener("change", ()=>{
    if ((0, _domJs.select).value === "all") (0, _productsJs.products).getProducts();
    else (0, _productsByJs.sortByCategory).getProductsByCategory();
});
...
window.addEventListener("click", (e)=>{
    ...
    if (target.classList.contains("main", "header") || target.classList.contains("header") || e.key === "Escape") (0, _cardJs.showCard).closeCard();
});
...
class Products {
    async getProducts() {
        try {
            const data = await (0, _helperJs.getJSON)(`${(0, _apiJs.BASE_URL)}`);
            (0, _domJs.container).innerHTML = "";
            return (0, _uiJs.createUI).createUI(data);
        } catch (error) {
            console.error(error);
        }
    }
...
},{"../api.js":"in4Qx","../DOM.js":"aClWA","./helper.js":"9xmJx","./UI.js":"eSl2s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"in4Qx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"aClWA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eSl2s":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createUI", ()=>createUI);
var _domJs = require("../DOM.js");
class UI {
    createUI(data) {
    ...
    createCardUI(data) {
        (0, _domJs.cardContainer).innerHTML = `
...
},{"../DOM.js":"aClWA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9f2pY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Category {
    async setCategories() {
        try {
            const data = await (0, _helperJs.getJSON)(`${(0, _apiJs.BASE_URL)}/categories`);
            data.forEach((element)=>{
                (0, _domJs.select).innerHTML += `
...
},{"../api.js":"in4Qx","../DOM.js":"aClWA","./helper.js":"9xmJx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cbV1b":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sortByCategory", ()=>sortByCategory);
var _domJs = require("../DOM.js");
var _apiJs = require("../api.js");
var _uiJs = require("./UI.js");
var _helperJs = require("./helper.js");
class ProductsByCategory {
    async getProductsByCategory() {
        const value = (0, _domJs.select).value;
        (0, _domJs.loader).classList.remove("hide");
        (0, _domJs.container).classList.add("fade");
        try {
            const data = await (0, _helperJs.getJSON)(`${(0, _apiJs.BASE_URL)}/category/${value}`);
            (0, _domJs.loader).classList.add("hide");
            (0, _domJs.container).classList.remove("fade");
            (0, _domJs.container).innerHTML = "";
            (0, _uiJs.createUI).createUI(data);
        } catch (error) {
            console.error(error);
        }
    }
}
let sortByCategory = new ProductsByCategory();

},{"../DOM.js":"aClWA","../api.js":"in4Qx","./UI.js":"eSl2s","./helper.js":"9xmJx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"86oNy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Card {
    closeCard() {
        ...
        (0, _domJs.cardContainer).classList.add("hide");
        (0, _domJs.wrapper).classList.remove("fade");
        (0, _domJs.select).disabled = false;
        (0, _domJs.cardContainer).innerHTML = "";
    }
    async showDetailedProduct(id) {
        ...
        try {
            ...
            (0, _uiJs.createUI).createCardUI(data);
        } catch (err) {
            console.error(err);
        }
    }
